...
public class Logger
{
    ...
    public void log(long l, String img, boolean grid, boolean temp, double[] D)
    {
        String delim = getDelimiter();
        try
        {
            ...
            sb.append(l + delim).append(img + delim).append(grid + delim).append(temp + delim);
            writer.write(l + delim + img + delim + grid + delim + temp + delim);
